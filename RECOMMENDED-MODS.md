...
| [Capture Nets](https://modrinth.com/mod/capture-nets) | `k4TlctPD` (0.3.2+mc1.21.1) | Answers "how do you get a mob back to your 1-block base" - a reusable net that catches any passive/neutral mob (including modded ones), no charges or durability loss. Needed a `neo_version` bump (176 -> 247, see TODO-DONE.md) to unblock - every build needs neoforge>=21.1.234. |
